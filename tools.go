...
// in the broswer window by setting content disposition
...
func (t *Tools) ReadJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	...
	if err != nil {
		...
		case errors.Is(err, io.ErrUnexpectedEOF):
			return errors.New("body contains badly-bormed JSON")
...
// WriteJSON takes a response status code and arbituray data and does stuff
...
// ErrorJSON takes an error, and optionally a stauts code, and generates an error message
...
// The final parameter, client, is optional. If none is specified, we use the statnadr http.Client
